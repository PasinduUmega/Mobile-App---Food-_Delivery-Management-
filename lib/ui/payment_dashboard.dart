  ...
  Future<void> _proceedToPayment() async {
    ...
    try {
      ...
      if (!_payNow) {
        AppFeedback.success(
          context,
          'Order placed. Pay the driver cash on delivery.',
        );
      ...
      if (result == true) {
        ...
        // Payment not completed → order still exists (PENDING_PAYMENT). Driver can collect COD.
        AppFeedback.success(
          context,
          'Order placed. You can pay the driver cash on delivery.',
        );
        Navigator.of(context).popUntil((route) => route.isFirst);
      }
    } catch (e) {
            ...
            child: _loading
                ...
                : Text(
                    _payNow
                        ...
                        : 'Place order (COD) · LKR ${_total.toStringAsFixed(2)}',
                    style: const TextStyle(
                      fontWeight: FontWeight.w800,
                      fontSize: 16,
                    ),
