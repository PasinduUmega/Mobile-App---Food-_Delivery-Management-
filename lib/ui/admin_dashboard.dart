          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: MobilePartitionCard(
                ...
                subtitle:
                    'Use these partitions to navigate each module with clear RBAC boundaries.',
                margin: EdgeInsets.zero,
                child: FilledButton.tonalIcon(
                  onPressed: null,
                  icon: const Icon(Icons.grid_view_rounded),
                  label: const Text('Seven-module CRUD suite disabled for admin'),
                ),
              ),
            ),
          ),
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                _buildModuleCard(
                  ...
                  const Color(0xFFFF6A00),
                  const RestaurantManagementDashboard(readOnly: true),
                ),
                _buildModuleCard(
                  context,
                  ...
                  const OrderManagementDashboard(readOnly: true),
                ),
                _buildModuleCard(
                  context,
                  'Delivery & Logistics',
                ...
                _buildModuleCard(
                  ...
                  const MenuManagementDashboard(readOnly: true),
                ),
                _buildModuleCard(
                  context,
                  'User Administration',
                ...
                _buildModuleCard(
                  ...
                  const InventoryManagementDashboard(readOnly: true),
                ),
                _buildModuleCard(
                  context,
                  'Finance & Payments',
